...
def main(args=sys.argv[1:]):
    ...
    parser.add_argument("--hard_attention", dest="hard_attention", type=bool, default=False, help="Should we use hard attention?")
    ...
    ### LOAD THE MODEL ###
    model = create_model(dataset=parser.dataset, bert_backprop=parser.bert_backprop, ner_loss=parser.ner_loss, hard_attention = parser.hard_attention)
