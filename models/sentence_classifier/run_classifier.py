...
flags.DEFINE_string(
    "bert_config_file", os.path.join(config.SCI_BERT_DIR, 'bert_config.json'),
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string(
    "init_checkpoint", os.path.join(config.SCI_BERT_DIR, 'bert_model.ckpt'),
    "Initial checkpoint (usually from a pre-trained BERT model).")

flags.DEFINE_string("vocab_file", os.path.join(config.SCI_BERT_DIR, 'vocab.txt'),
